module FileUtils
  ...
  LOW_METHODS = [:chdir, :getwd, :pwd, :private_module_function, :cd, :identical?, :commands, :uptodate?, :options_of, :collect_method, :remove_file, :copy_file, :copy_entry, :options, :copy_stream, :remove_entry_secure, :remove_entry, :remove_dir, :compare_file, :have_option?, :compare_stream, :cmp]
  LowMethods = FileUtils::LowMethods
  METHODS = [:chdir, :getwd, :pwd, :mkdir, :rmdir, :cd, :identical?, :mkdir_p, :uptodate?, :mkpath, :chmod, :chown, :makedirs, :link, :symlink, :ln, :remove_file, :ln_s, :ln_sf, :cp, :install, :copy_file, :copy, :cp_r, :remove, :copy_entry, :copy_stream, :mv, :remove_entry_secure, :remove_entry, :move, :rm, :rm_f, :safe_unlink, :rm_r, :rm_rf, :rmtree, :remove_dir, :compare_file, :compare_stream, :cmp, :chmod_R, :chown_R, :touch]
